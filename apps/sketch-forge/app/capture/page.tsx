...
import { SketchCanvas } from "../canvas/_components/SketchCanvas";
import { CaptureToolbar } from "./_components/CaptureToolbar";
...
export default function QuickCapturePage() {
  ...
  useEffect(() => {
    workerRef.current = new Worker(
      new URL("../canvas/_workers/thumbnail.worker.ts", import.meta.url),
    );
    return () => {
